...
### Objetivo 3: Desenvolver soluções de baixo custo para armazenamento e uso de energia solar.
- **KR1:** Concluir o desenvolvimento do protótipo **Sun Block** (bloqueio de excedente de energia) até o mês 4. **(🔄 Em andamento)**  
- **KR2:** Finalizar o protótipo **Loop Grid**, substituto de baterias de lítio, até o mês 5. **(🔄 Em andamento)**  
- **KR3:** Validar o desempenho dos protótipos com testes de campo até o mês 6.  
...
| 5   | Validação e crescimento    | Testes de campo, Loop Grid protótipo **(🔄 Em andamento)** |
...
| Sprint 4   | ⬜️ Não iniciado | Iteração de melhorias com base no feedback        |
| Sprint 5   | ⬜️ Não iniciado | Estratégias de alcance e comunidade               |
| Sprint 6   | 🔄 Em andamento | Apresentação final, métricas, relatório geral **(Slide em andamento)** |
